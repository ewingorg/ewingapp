...
document.getElementById("addressDefault").addEventListener('tap', function() {
	...
	ajax.jsonpSyncFetch("address/setDefault.action", requestJson, 'setDefault');
});
...
document.getElementById("addAddress").addEventListener('tap', function() {
	...
	ajax.jsonpSyncFetch("address/saveAddr.action", requestJson, 'saveAddr');
});

function saveAddr(json) {
	if (null == json || '' == json) {
		return false;
	}
...
function init() {
	...
	ajax.jsonpSyncFetch("address/findAddr.action", requestJson, 'findAddr');
